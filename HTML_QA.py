...
url = 'https://www.yamu.lk/kamu/oktoberfest-2023-at-hilton-colombo/'
...
embeddings = OpenAIEmbeddings(openai_api_key='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')
...
chat_llm = ChatOpenAI(model=MODEL,
                      temperature=0,
                      max_tokens=200,
                      openai_api_key='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',
                      verbose=True)
...
# Display the response if the submit button is clicked
if submit_button:
    st.write(response)
